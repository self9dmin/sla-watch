...
- Opens on a compact Coverage workspace with provider, service, incident, and filing facts above one service coverage worklist.
...
3. Open **Coverage**. Review Smartscape recommendations and services without runtime context in the same worklist, then confirm the provider terms used by Incidents and Evidence. Existing source tags remain read-only evidence.
