...
7. Under **Covered**, select a service to preview its customer objective. Creation is optional, requires objective write access, and creates only one app-managed objective for that provider and service.
