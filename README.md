...
- Provides an Evidence workspace that carries the selected review case forward and assembles all supporting Problems, affected-service request and failure telemetry, native objective posture, applicable terms, exclusions, and required evidence into one compact follow-up package. The SRE saves Package ready, Not ready, or Not provider-related. Each underlying Problem retains its own audited decision, provider reports remain optional supporting evidence, and nothing is submitted.
