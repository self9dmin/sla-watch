...
- Provides an Evidence workspace that assembles Dynatrace-derived candidates, applicable terms, and required evidence into a compact claim package. The SRE marks the package ready or not provider-related, while provider reports remain a separate optional view. Nothing is submitted.
