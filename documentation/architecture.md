...
- Incidents is deliberately not a second Problems app. It pages eight records, prioritizes active and provider-relevant Problems, and exposes only the provider-review decision context. Full root-cause analysis, logs, traces, filters, and remediation stay in the native Problems app.
