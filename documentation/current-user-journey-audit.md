...
**Persona:** an SRE or operations responder who owns customer impact review but may not own the provider contract or cloud account.

**Job to be done:** When a customer-facing service degrades and relies on an external provider, help me establish the provider boundary, compare Dynatrace-observed impact with applicable terms and provider reports, and produce a defensible review outcome without manually rebuilding the relationship between services, runtimes, incidents, and contract terms.
