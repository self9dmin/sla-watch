...
This note records the dependency posture for the `0.0.31` release candidate. It is intentionally explicit so a public-repository reviewer can distinguish production risk from upstream development-tooling findings.
