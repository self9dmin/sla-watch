...
This note records the dependency posture for the `0.0.37` release, verified with Node.js 24.19.0. It is intentionally explicit so a public-repository reviewer can distinguish production risk from upstream development-tooling findings.
