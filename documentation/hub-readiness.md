...
| Themes | Custom styles use theme variables and dark/light paths were manually verified in the target tenant | Verified in the installed `0.0.30` release | Add automated contrast or screenshot coverage before submission. |
