...
| Confirmed coverage mappings | Authenticated app users with App Settings read access | Users with App Settings write access for `provider-scope-assignments` | Exact Smartscape service/runtime IDs or direct service IDs are retained; candidates stay unconfirmed until saved in Coverage |
