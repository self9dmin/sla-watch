...
| Provider configuration | Settings | Add a dependency that topology or source tags cannot reveal | Deliberate configuration | Manual additions could be mistaken for Dynatrace evidence | Mark them as added manually and keep them separate from detected providers |
