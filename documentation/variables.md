...
| `evidence-decisions` | Package-ready, not-ready, or not-provider-related review state plus acknowledged evidence items | Environment-shared App Settings | Authorized SRE decision in Evidence | Persists until reopened or replaced; Settings keeps version history | High: operational follow-up state that must not be represented as provider fault, credit approval, or claim submission |
